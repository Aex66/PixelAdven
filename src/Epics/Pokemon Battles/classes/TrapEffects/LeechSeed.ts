...
export class LeechSeed extends TrapEffect {
  readonly name = "Leech Seed";
  ...
  applyEffect(attacker: Pokemon, target: Pokemon, battle: Battle) {
    ...
    battle.message(`§d${grammarText(target.entity.typeId)}§f had its energy drained by Leech Seed!`)
  }
}
