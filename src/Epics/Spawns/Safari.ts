...
// 🦓 Safari Zone Pokémon Rarity Groups
const common = [
  'wild_nidoran_f','wild_nidoran_m','wild_paras','wild_venonat','wild_exeggcute',
  'wild_doduo','wild_hoothoot','wild_wooper','wild_starly','wild_budew',
  'wild_gulpin','wild_surskit','wild_stunky'
];

const uncommon = [
  'wild_nidorina','wild_nidorino','wild_parasect','wild_venomoth','wild_exeggutor',
  'wild_dodrio','wild_noctowl','wild_quagsire','wild_roselia','wild_masquerain',
  'wild_yanma','wild_aipom','wild_girafarig','wild_stantler','wild_swablu',
  'wild_staravia','wild_staraptor','wild_gloom','wild_roselia','wild_skourpi'
];

const rare = [
  'wild_nidoqueen','wild_nidoking','wild_exeggutor','wild_pinsir','wild_scyther',
  'wild_tauros','wild_quagsire','wild_tangela','wild_roserade','wild_toxicroak',
  'wild_drapion','wild_carnivine'
];

const veryRare = [
  'wild_kangaskhan','wild_chansey','wild_ursaring','wild_tangrowth','wild_yanmega',
  'wild_drapion','wild_toxicroak','wild_skuntank','wild_absol'
];

const ultraRare = [
  'wild_eevee','wild_porygon','wild_porygon2','wild_porygonz','wild_ditto','wild_snorlax'
];
...
system.runInterval(() => {
    for (const player of world.getPlayers()) {
        ...
        const inPlains = getScore(player, "Safari");
