...
// 🌾 Plains Biome Pokémon Rarity Groups (Stage-Based, No Repeats)
const common = [
  'wild_rattata','wild_raticate','wild_sentret','wild_furret',
  'wild_zigzagoon','wild_linoone','wild_bidoof','wild_bibarel',
  'wild_pidgey','wild_pidgeotto','wild_spearow','wild_fearow',
  'wild_taillow','wild_swellow','wild_starly','wild_staravia',
  'wild_doduo','wild_mareep','wild_shinx','wild_pachirisu',
  'wild_electrike','wild_plusle','wild_minun'
];

const uncommon = [
  'wild_pidgeot','wild_staraptor','wild_dodrio','wild_flaaffy',
  'wild_electabuzz','wild_luxio','wild_snubbull','wild_skitty',
  'wild_glameow','wild_buneary','wild_mankey','wild_primeape',
  'wild_makuhita','wild_spinda','wild_girafarig','wild_chatot'
];

const rare = [
  'wild_raichu','wild_ampharos','wild_manectric','wild_luxray',
  'wild_granbull','wild_delcatty','wild_lopunny','wild_tauros',
  'wild_stantler','wild_smeargle','wild_eevee','wild_espeon',
  'wild_umbreon'
];

const veryRare = [
  'wild_hitmonlee','wild_hitmonchan','wild_hitmontop',
  'wild_miltank','wild_porygon','wild_porygon2'
];

const ultraRare = [
  'wild_porygonz','wild_togetic','wild_togekiss','wild_snorlax'
];
...
system.runInterval(() => {
    for (const player of world.getPlayers()) {
        ...
        const inPlains = getScore(player, "Main");
