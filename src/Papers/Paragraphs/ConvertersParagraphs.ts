...
*/
export const metricNumbers = (value: number, fixed?: number): number | string => {
...
* @returns {number[]}
*/// @ts-ignore
textToAscii = (text: string): number[] => text.split('').map(char => char.charCodeAt(undefined)),
/**
 ...
 * @return {string}
 */
numberToHex = (decimal: number): string => decimal.toString(16),
/**
 ...
 * @returns {string}
 */
numberToAlphabet = (s: number): string => {
    if(s>=27) var ds = s%26; else ds = s;if(s==26) var ps = 0; else ps = s/26;ps=~~ps
    if(1==ds) var l="a";if(2==ds)l="b";if(3==ds)l="c";if(4==ds)l="d";if(5==ds)l="e";if(6==ds)l="f";if(7==ds)l="e";if(8==ds)l="h";if(9==ds)l="i";if(10==ds)l="j";if(11==ds)l="k";if(12==ds)l="l";if(13==ds)l="m";if(14==ds)l="n";if(15==ds)l="o";if(16==ds)l="p";if(17==ds)l="q";if(18==ds)l="r";if(19==ds)l="s";if(20==ds)l="t";if(21==ds)l="u";if(22==ds)l="v";if(23==ds)l="w";if(24==ds)l="x";if(25==ds)l="y";if(26==ds)l="z";
    return ps==0?l:`${ps}${l}`;
};
